...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   getLocationWeather: () => (/* binding */ getLocationWeather)\n/* harmony export */ });\n/* harmony import */ var _style_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../style/style.scss */ \"./src/style/style.scss\");\n/* harmony import */ var _dataExtractor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dataExtractor */ \"./src/scripts/dataExtractor.js\");\n/* harmony import */ var _weather__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./weather */ \"./src/scripts/weather.js\");\n/* harmony import */ var _display__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./display */ \"./src/scripts/display.js\");\n\r\n\r\n\r\n\r\n\r\n/**\r\n * Ask user for location data to make Weather API call\r\n * @returns {object} Weather API data object\r\n */\r\nasync function startUp() {\r\n    _display__WEBPACK_IMPORTED_MODULE_3__.displayData(); // Display blanks\r\n    _display__WEBPACK_IMPORTED_MODULE_3__.startLoading();\r\n    const coords = await _weather__WEBPACK_IMPORTED_MODULE_2__.getUserCoords();\r\n    const weatherData = await getLocationWeather(null, coords);\r\n    return weatherData;\r\n}\r\n\r\n/**\r\n * Get weather data using\r\n */\r\nasync function getLocationWeather(location = null, coords = null) {\r\n    try {\r\n        const weatherData = await _weather__WEBPACK_IMPORTED_MODULE_2__.getWeather(location, coords);\r\n        const data = await weatherData.json();\r\n        return (0,_dataExtractor__WEBPACK_IMPORTED_MODULE_1__.extractData)(data);\r\n    } catch {}\r\n}\r\n\r\ndocument.addEventListener('DOMContentLoaded', () => {\r\n    startUp()\r\n        .then((data) => {\r\n            _display__WEBPACK_IMPORTED_MODULE_3__.displayData(data);\r\n            _display__WEBPACK_IMPORTED_MODULE_3__.stopLoading();\r\n        })\r\n        .catch((e) => {\r\n            console.error(e);\r\n            _display__WEBPACK_IMPORTED_MODULE_3__.stopLoading();\r\n        });\r\n});\r\n\n\n//# sourceURL=webpack://weather-app/./src/scripts/index.js?");
...
/***/ "./src/style/font/Assistant/Assistant-VariableFont_wght.ttf":
/*!******************************************************************!*\
  !*** ./src/style/font/Assistant/Assistant-VariableFont_wght.ttf ***!
  \******************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
eval("module.exports = __webpack_require__.p + \"c69ef68f4c67b7fa0191.ttf\";\n\n//# sourceURL=webpack://weather-app/./src/style/font/Assistant/Assistant-VariableFont_wght.ttf?");
...
"use strict";
eval("module.exports = __webpack_require__.p + \"9f4affb242e527ea467f.svg\";\n\n//# sourceURL=webpack://weather-app/./src/style/loading/spinner.svg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   addLeadingZeros: () => (/* binding */ addLeadingZeros)\n/* harmony export */ });\nfunction addLeadingZeros(number, targetLength) {\n  const sign = number < 0 ? \"-\" : \"\";\n  const output = Math.abs(number).toString().padStart(targetLength, \"0\");\n  return sign + output;\n}\n\n\n//# sourceURL=webpack://weather-app/./node_modules/date-fns/_lib/addLeadingZeros.mjs?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   getDefaultOptions: () => (/* binding */ getDefaultOptions),\n/* harmony export */   setDefaultOptions: () => (/* binding */ setDefaultOptions)\n/* harmony export */ });\nlet defaultOptions = {};\n\nfunction getDefaultOptions() {\n  return defaultOptions;\n}\n\nfunction setDefaultOptions(newOptions) {\n  defaultOptions = newOptions;\n}\n\n\n//# sourceURL=webpack://weather-app/./node_modules/date-fns/_lib/defaultOptions.mjs?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   buildFormatLongFn: () => (/* binding */ buildFormatLongFn)\n/* harmony export */ });\nfunction buildFormatLongFn(args) {\n  return (options = {}) => {\n    // TODO: Remove String()\n    const width = options.width ? String(options.width) : args.defaultWidth;\n    const format = args.formats[width] || args.formats[args.defaultWidth];\n    return format;\n  };\n}\n\n\n//# sourceURL=webpack://weather-app/./node_modules/date-fns/locale/_lib/buildFormatLongFn.mjs?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   buildMatchPatternFn: () => (/* binding */ buildMatchPatternFn)\n/* harmony export */ });\nfunction buildMatchPatternFn(args) {\n  return (string, options = {}) => {\n    const matchResult = string.match(args.matchPattern);\n    if (!matchResult) return null;\n    const matchedString = matchResult[0];\n\n    const parseResult = string.match(args.parsePattern);\n    if (!parseResult) return null;\n    let value = args.valueCallback\n      ? args.valueCallback(parseResult[0])\n      : parseResult[0];\n\n    // eslint-disable-next-line @typescript-eslint/no-explicit-any -- I challange you to fix the type\n    value = options.valueCallback ? options.valueCallback(value) : value;\n\n    const rest = string.slice(matchedString.length);\n\n    return { value, rest };\n  };\n}\n\n\n//# sourceURL=webpack://weather-app/./node_modules/date-fns/locale/_lib/buildMatchPatternFn.mjs?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   formatRelative: () => (/* binding */ formatRelative)\n/* harmony export */ });\nconst formatRelativeLocale = {\n  lastWeek: \"'last' eeee 'at' p\",\n  yesterday: \"'yesterday at' p\",\n  today: \"'today at' p\",\n  tomorrow: \"'tomorrow at' p\",\n  nextWeek: \"eeee 'at' p\",\n  other: \"P\",\n};\n\nconst formatRelative = (token, _date, _baseDate, _options) =>\n  formatRelativeLocale[token];\n\n\n//# sourceURL=webpack://weather-app/./node_modules/date-fns/locale/en-US/_lib/formatRelative.mjs?");
